...
There are also 2 options for the calculation of standard errors: `.ClusterSE`. and `.RobustSE`. 
`.ClusterSE`. supersedes `.RobustSE`.in priority if both are set. 
`.ClusterSE`. takes the name of a variable to cluster by, using the "HC1", 
